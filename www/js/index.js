...
          //alert("latitude is: "+ lat+ " longitude is: "+ longi);
     ...
     /*i can write it like that to add marker to map*/
			if (typeof app.map == 'undefined') {
					app.map = new google.maps.Map(document.getElementById('map'), {center: myLatLng, zoom: 14});
			}
			marker1=new google.maps.Marker({position:myLatLng, map:app.map, draggable: true, animation: google.maps.Animation.DROP});
         
      },
             
